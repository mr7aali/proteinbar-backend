...
exports.publicRouter.get("/monthly-plans", public_controller_1.publicController.listMonthlyPlans);
exports.publicRouter.get("/monthly-plans/:planId", public_controller_1.publicController.getMonthlyPlanById);
exports.publicRouter.get("/products", public_controller_1.publicController.listProducts);
exports.publicRouter.get("/products/:handle", public_controller_1.publicController.getProductByHandle);
exports.publicRouter.get("/locations", public_controller_1.publicController.listLocations);
exports.publicRouter.get("/builder-ingredients", public_controller_1.publicController.listBuilderIngredients);
